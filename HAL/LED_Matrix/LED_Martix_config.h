...
#define COL1_PIN            PIN1
#define COL2_PORT           GPIOB
#define COL2_PIN            PIN2
#define COL3_PORT           GPIOB
#define COL3_PIN            PIN3
#define COL4_PORT           GPIOB
#define COL4_PIN            PIN4
#define COL5_PORT           GPIOB
#define COL5_PIN            PIN5
#define COL6_PORT           GPIOB
#define COL6_PIN            PIN6
#define COL7_PORT           GPIOB
#define COL7_PIN            PIN7
